    ...
    test('Test formatter with same configuration as example app', () {
      ...
      final formatter = PatternInputFormatter(
        patterns: [
          ...
          'AA## AAA', // Handles RH19 KAA and similar (newly added)
        ],
        inputType: PatternInputType.postal,
      );

      print('Testing UK postcode formatter with RH19KAA input...\n');

      // Simulate typing "RH19KAA" character by character
      String currentText = '';
      int currentCursor = 0;
      
      final inputChars = ['R', 'H', '1', '9', 'K', 'A', 'A'];
      ...
      for (int i = 0; i < inputChars.length; i++) {
        ...
        try {
          ...
          print('Result: "${result.text}" (cursor at ${result.selection.baseOffset})');
